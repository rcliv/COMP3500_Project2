/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/mips.md'.  */
...
#line 23 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 31 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 39 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 43 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 51 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
#line 55 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(INTVAL (op) + 1 != 0));
}
...
#line 59 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
#line 63 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT || GET_CODE (op) == CONST_DOUBLE || GET_CODE (op) == CONST_VECTOR) && (
#line 68 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && ((
#line 77 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(op == CONST0_RTX (GET_MODE (op)))) || (
#line 78 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(op == CONST1_RTX (GET_MODE (op)))));
}
...
#line 82 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(FP_REG_P (REGNO (op))))) && (
...
{
  return ((GET_CODE (op) == REG) && (
#line 86 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(REGNO (op) == LO_REGNUM))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 90 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
#line 97 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
...
#line 130 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
{
  return (
#line 159 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(CONSTANT_P (op))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 163 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
...
#line 170 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
...
#line 177 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
...
#line 184 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
  enum mips_symbol_type type;
...
#line 191 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
...
#line 196 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
{
...
#line 194 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(ISA_HAS_MACC))) || ((GET_CODE (op) == MINUS) && (
#line 195 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
(ISA_HAS_MSAC)))) && (
...
#line 218 "/root/cs161/cs161-gcc-1.5/./gcc-4.1.2+cs161/gcc/config/mips/predicates.md"
